...
Config.Stores = {
    [1] = {shopType = 'clothing', coords = vector3(1693.32, 4823.48, 41.06), width = 9, length = 9},
    [2] = {shopType = 'clothing', coords = vector3(-712.215881, -155.352982, 37.4151268), width = 9, length = 9},
    [3] = {shopType = 'clothing', coords = vector3(-1192.94495, -772.688965, 17.3255997), width = 9, length = 9},
    [4] = {shopType = 'clothing', coords = vector3(425.236, -806.008, 28.491), width = 9, length = 9},
    [5] = {shopType = 'clothing', coords = vector3(-162.658, -303.397, 38.733), width = 9, length = 9},
    [6] = {shopType = 'clothing', coords = vector3(75.950, -1392.891, 28.376), width = 9, length = 9},
    [7] = {shopType = 'clothing', coords = vector3(-822.194, -1074.134, 10.328), width = 9, length = 9},
    [8] = {shopType = 'clothing', coords = vector3(-1450.711, -236.83, 48.809), width = 9, length = 9},
    [9] = {shopType = 'clothing', coords = vector3(4.254, 6512.813, 30.877), width = 9, length = 9},
    [10] = {shopType = 'clothing', coords = vector3(615.180, 2762.933, 41.088), width = 9, length = 9},
    [11] = {shopType = 'clothing', coords = vector3(1196.785, 2709.558, 37.222), width = 9, length = 9},
    [12] = {shopType = 'clothing', coords = vector3(-3171.453, 1043.857, 19.863), width = 9, length = 9},
    [13] = {shopType = 'clothing', coords = vector3(-1100.959, 2710.211, 18.107), width = 9, length = 9},
    [14] = {shopType = 'clothing', coords = vector3(-1207.65, -1456.88, 4.3784737586975), width = 9, length = 9},
    [15] = {shopType = 'clothing', coords = vector3(121.76, -224.6, 53.56), width = 9, length = 9},
    [16] = {shopType = 'barber', coords = vector3(-814.3, -183.8, 36.6), width = 9, length = 9},
    [17] = {shopType = 'barber', coords = vector3(136.8, -1708.4, 28.3), width = 9, length = 9},
    [18] = {shopType = 'barber', coords = vector3(-1282.6, -1116.8, 6.0), width = 9, length = 9},
    [19] = {shopType = 'barber', coords = vector3(1931.5, 3729.7, 31.8), width = 9, length = 9},
    [20] = {shopType = 'barber', coords = vector3(1212.8, -472.9, 65.2), width = 9, length = 9},
    [21] = {shopType = 'barber', coords = vector3(-32.9, -152.3, 56.1), width = 9, length = 9},
